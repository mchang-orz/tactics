...
func CreateEquippableItem(title:String, type:StatTypes.Stat, amount:int, slot:EquipmentSlots.Slot):
	var item:Node = CreateItem(title, type, amount)
...
func CreateItems():
	...
	inventory.append(CreateEquippableItem("Sword", StatTypes.Stat.ATK, 10, EquipmentSlots.Slot.PRIMARY))
	inventory.append(CreateEquippableItem("Broad Sword", StatTypes.Stat.ATK, 15, EquipmentSlots.Slot.PRIMARY | EquipmentSlots.Slot.SECONDARY))
	inventory.append(CreateEquippableItem("Shield", StatTypes.Stat.DEF, 10, EquipmentSlots.Slot.SECONDARY))
