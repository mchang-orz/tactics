...
var State:States:
	...
	set(value):
		...
		if IsLocked:
			...
			label.set(font_outline_color,Color(0.078431, 0.141176,0.172549)) #rgb 20 35 44
		elif IsSelected:
...
#bitwise operations for locked and selected states
var IsLocked:bool:
	get:
	...
	set(value):
		if value:
			...
			State &= ~States.LOCKED #NOT OPERATOR ~
...
var IsSelected:bool:
	...
	set(value):
		if value:
			...
			State &= ~States.SELECTED #NOT OPERATOR ~
